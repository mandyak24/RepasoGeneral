<!-- Ejercicio 8
Partiendo del ejercicio 4 donde desarrollaste una pequeña agenda, añade un par de
elementos que tengan cuentas de correo no válidas, así como una función de usuario que
reciba el correo electrónico de cada contacto de la agenda que devuelva true si el correo

termina en “@gmail.com”, “@educa.madrid.org”, “@yahoo.com”, “@outlook.com” o
“@hotmail.com” y false en caso contrario. -->
...
de alta en la agenda. -->
    ...
    if ((isset($_POST['enviar']))) {
        ...
        if(validarEmail($email)!=true){
            $errores['email']="Dominio invalido";
        };
        if (empty($email)) {
    ...
    {
        //Esto nos da un array que separa en dos valores el correo el 0 es el nombre de usuario y el 1 el dominio 
        $separar = explode("@", $email);
        //Creamos un array con los dominios permitidos
        $permitir = array("gmail.com", "educa.madrid.org", "yahoo.com", "outlook.com", "hotmail.com");
        //Seleccionamos la parte del dominio
        $dominio = $separar[1];
        //Comprobamos que la parte del dominio esta en el array $permitir, si esta devuelve true si no false, 
        // mas arriba comprobamos que sea true o false para  mandar un error si resultare false.
        if (in_array($dominio, $permitir)) {
           return true;
        }else{
            return false;
        }
